...
import 'package:search_location_weather_app/components/search_bar.dart';
import 'package:search_location_weather_app/models/weather_model.dart';
import 'package:search_location_weather_app/services/weatherservice.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  _getWeatherData(String location) async {
    ...
    try {
      response = await WeatherService().getCurrentWeather(location);
